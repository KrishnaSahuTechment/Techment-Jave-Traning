package com.techment.Assignments.ExceptionsAssignments.Program2;
...
public class TestCustomer {
	...
	public static void main(String[] args) {
		...
		Customer customer1 = new Customer("Cba","Krishna","Platinum");
		Customer customer2 = new Customer("b02","Anmol","Diamond");
		Customer customer3 = new Customer("C03","Dev","Silver");
		Customer customer4 = new Customer("CIA","Devesh","Silver");
