...
public class MergeArrays {
	...
	public static void main(String[] args) {
		...
		System.out.println("================================================");
		System.out.println("ok size of 1st array = "+arrayFirst);
		System.out.println("================================================");
		...
		System.out.print("Enter the size of 1st array  =  ");
		int arraySecond = scannerSecond.nextInt();
		System.out.println("================================================");
		System.out.println("ok size of 1st array = "+arraySecond);
		System.out.println("================================================");
		int arrayB[] = new int[arraySecond];
		
		Scanner scanValueSecond = new Scanner(System.in);
		System.out.print("Enter the value for second array = ");
		for(int i=0;i<arrayB.length;i++)
		{	System.out.print("Enter the value for index ["+i+"] = ");
		arrayB[i] = scanValueSecond.nextInt();
		}
